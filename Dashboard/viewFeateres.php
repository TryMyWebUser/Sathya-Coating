<?php
    ...
    $featere = Operations::getHomeFeateres($conn);
            ...
            <main class="page-content">
                <div class="container-fluid">
                    <div class="row g-3">
                        <?php
                        if (!empty($featere)) {
                            foreach ($featere as $hf) {
                        ?>
                        <div class="col-lg-4 col-md-6">
                            <!-- Card -->
                            <div class="card">
                                <img class="card-img-top img-responsive" src="<?= $hf['img']; ?>" alt="Card image" />
                                <div class="p-3 pb-0">
                                    <h4><?= $hf['title'] ?></h4>
                                    <p><?= $hf['dec'] ?></p>
                                    <p class="p-0 m-0">Points: <?= $hf['points'] ?></p>
                                </div>
                                <div class="card-body">
                                    <a href="editFeateres.php?edit_id=<?= $hf['id']; ?>" class="btn btn-outline-info btn-sm me-1" title="Edit">
                                    ...
                                    <a href="deleteFeateres.php?delete_id=<?= $hf['id']; ?>" class="btn btn-outline-danger btn-sm ms-1" title="Delete">
                        ...
                        <?php 
                            ...
                            echo "<div class='col-12'><p class='text-center text-muted'>Feateres Not Found</p></div>"; 
                        } 
                        ?>
                    </div>
                </div>
