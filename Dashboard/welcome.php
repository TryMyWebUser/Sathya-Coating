                    ...
                    <div class="col-12 col-lg-4 col-xl-4 d-flex">
                        <div class="card radius-10 w-100">
                            ...
                            <ul class="list-group list-group-flush mb-0">
                                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">New Orders<span class="badge bg-primary badge-pill">25%</span></li>
