                ...
                <div class="container-fluid">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <!-- Card -->
                            <div class="card">
                                <img class="card-img-top img-responsive" src="<?= $h['img']; ?>" alt="Card image" />
                                <div class="p-3 pb-0">
                                    <h4 class="card-title">Header: <?= $h['header']; ?></h4>
                                    <h5>Title: <?= $h['title'] ?></h5>
                                    <p>Dec: <?= $h['dec'] ?></p>
                                    <p>Button Text_1: <?= $h['button_text1'] ?></p>
                                    <p class="p-0 m-0">Button Text_2: <?= $h['button_text2'] ?></p>
                                </div>
                                <div class="card-body">
                                    <a href="editHero.php?edit_id=<?= $h['id']; ?>" class="btn btn-outline-info btn-sm me-1" title="Edit">
                                    ...
                                    <a href="deleteHero.php?delete_id=<?= $h['id']; ?>" class="btn btn-outline-danger btn-sm ms-1" title="Delete">
