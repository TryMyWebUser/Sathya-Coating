<?php
    ...
    $aboutus = Operations::getHomeAboutUs($conn);
?>
                        ...
                        <div class="row row-cols-12 row-cols-lg-12 justify-content-center g-lg-12">
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <a href="editHomeAbout.php?edit_id=<?= $row['id'] ?>" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                                    <a href="deleteHomeAbout.php?delete_id=<?= $row['id'] ?>" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                                    </div>
                                </div>
                            </div>
                            <?php
